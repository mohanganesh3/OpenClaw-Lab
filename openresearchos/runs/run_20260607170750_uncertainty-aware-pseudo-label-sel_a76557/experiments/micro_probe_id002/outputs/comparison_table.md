...
## Idea
Class-balanced pseudo-labeling for scarce medical labels

## Hypothesis
Class-balanced low-entropy selection will reduce minority-class collapse and improve macro/weighted F1 against max-confidence selection.
