...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601125746_traceable-autonomous-research-agen_73a931/experiments/micro_probe_id010
```
...
```json
{
  ...
  "approved_at": "2026-06-01T12:57:46.471Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
