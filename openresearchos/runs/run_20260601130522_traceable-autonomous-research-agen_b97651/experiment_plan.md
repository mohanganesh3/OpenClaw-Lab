...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601130522_traceable-autonomous-research-agen_b97651/experiments/micro_probe_id010
```
...
```json
{
  ...
  "approved_at": "2026-06-01T13:05:23.046Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
