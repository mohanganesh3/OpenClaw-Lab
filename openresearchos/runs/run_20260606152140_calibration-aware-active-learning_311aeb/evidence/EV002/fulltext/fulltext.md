...
[CAPTION] Table 1 | Comparison of AI Scientist Versions. Comparison highlights key advancements in The AI
...
[CAPTION] Figure 1 | The AI Scientist-v2 Workflow. The workflow consists of several phases covering
...
[CAPTION] Figure 2 | The AI Scientist-v2 workflow showing different stages of tree-based experimentation.
...
[CAPTION] Figure 3 | Peer-reviewed ICBINB workshop paper generated by The AI Scientist-v2. The
...
AI Generated Papers
31
C.1 Compositional Regularization: Unexpected Obstacles in Enhancing Neural Network
Generalization
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
32
C.1.1
...
57
C.3
Real-world Challenges in Pest Detection using Deep Learning: an Investigation into
...
8,192
0.5
LLM/VLM Feedback Agents (§3.4)
GPT-4o
8,192
0.5
Summary Report Agent (§3)
GPT-4o
8,192
1.0
...
Maximum Debug Depth
3
Maximum Experiment Runtime per Node
1 hour
...
[CAPTION] Table 2 | LLM and VLM Hyperparameters.

[CAPTION] Table 3 | Agentic Tree Search & Execution Hyperparameters (§3.2.2, §3.2.1).
...
[CAPTION] Table 4 | Overview of AI-Generated Workshop Submissions.
...
BY THE AI SCIENTIST-V2
AI Scientist-v2 Generated Preprint
...
sions, such as using more operators or nesting
Comment:
The dataset
used in the
experiments
...
rating more
operators.
, exacerbates the models’ generalization difficulties
...
3.1
MODEL ARCHITECTURE
We use an LSTM-based neural network (Goodfellow et al., 2016)
Comment:
This should be
Hochreiter &
Schmidhuber
(1997).
to model the mapping from input
...
3.2
COMPOSITIONAL REGULARIZATION
Let ht be the hidden state at time t. We define the compositional regularization term as the mean
Comment:
This should be
more precise.
E.g. refer to
...
of Figure 1 is
truncated.
Right: Compositional loss remains steady, suggesting the model does not inherently develop
...
confusing.
4.2.2
IMPACT OF COMPOSITIONAL REGULARIZATION
We introduced the compositional regularization term with different weights λ and assessed its im-
pact. Figure 2 illustrates the effects of varying λ on training loss, compositional loss, and final test
accuracy. Higher values of λ led to a lower compositional loss but did not improve test accuracy.
...
[CAPTION] Figure 1: Baseline model performance over epochs. Left: Training and test loss decrease over
...
BY THE AI SCIENTIST-V2
AI Scientist-v2 Generated Preprint
Figure 2: Impact of compositional weight λ on model performance. Left: Training loss over epochs
for different λ. Higher λ values slightly increase training loss. Middle: Compositional loss de-
creases with higher λ,
Comment:
This is a
stretch because
the paper has
...
compositional-
ity.
indicating the regularization term effectively enforces compositionality.
Right: Final test accuracy does not improve with higher λ and may decrease, suggesting a trade-off
...
roughly the
same.
accuracy decreases significantly as operator complexity increases, underscoring
...
[CAPTION] Figure 2: Impact of compositional weight λ on model performance. Left: Training loss over epochs

[CAPTION] Figure 3: Model performance on expressions with varying operator complexity. Left: Training
...
appears to be
plateauing.
the embedding dimension did not consistently improve test accuracy. While
...
[CAPTION] Figure 4: Effect of embedding dimension on model performance. Left: Training loss decreases
...
C.1
ABLATION STUDY ON COMPOSITIONAL WEIGHT
We conducted an ablation study on the compositional weight λ to further investigate its impact on
model performance. Figures 6 and 7 show the training loss and final test accuracy for various values
of λ. Higher λ values effectively reduce the compositional loss but adversely affect test accuracy.
This reinforces the conclusion that emphasizing compositional regularization may conflict with the
primary learning objective.
C.2
COMPARISON OF LSTM AND RNN ARCHITECTURES
...
[CAPTION] Figure 5: Comparison of baseline and attention models. Left: Training loss over epochs shows sim-
...
λ leads to slightly higher training loss, indicating potential interference with the primary learning
objective.
Figure 7: Final test accuracy for different values of compositional weight λ. Higher λ values do
...
[CAPTION] Figure 6: Training loss over epochs for different values of compositional weight λ. Increasing

[CAPTION] Figure 7: Final test accuracy for different values of compositional weight λ. Higher λ values do

[CAPTION] Figure 8: Comparison of LSTM and RNN architectures. Left: Training loss over epochs shows
...
BY THE AI SCIENTIST-V2
AI Scientist-v2 Generated Preprint
Figure 9: Final test accuracy for different dropout rates.
Comment:
The figure
only shows
the best con-
...
rates are in-
cluded.
Higher dropout rates did not enhance
...
[CAPTION] Figure 9: Final test accuracy for different dropout rates.
...
Paper Summary
This paper investigates the impact of a temporal consistency regularization term
...
<!-- page 42 -->
The AI Scientist-v2: Workshop-Level Automated Scientific Discovery via Agentic Tree Search
actually induces compositional representations. This could be done for example via linear probes
...
[CAPTION] Figure 4 | Example of the data generating function used in the experiments.
...
[CAPTION] Figure 5 | The generated model class shows an embedding layer, a single LSTM layer, and a linear

[CAPTION] Figure 6 | The generated training loop shows the loss function as well as the proposed regularization.

[CAPTION] Figure 7 | The generated accuracy calculation function uses regression to match an output with a
...
ability of uncertainty estimates. We demonstrate that standard mitigation
Comment:
No empirical
evidence for
this claim.
...
BY THE AI SCIENTIST-V2
AI Scientist-v2 Generated Preprint
• We provide a systematic analysis of the impact of label noise on model calibration across
Comment:
Are the experi-
ments system-
atic enough?
...
Label noise has been extensively studied regarding its impact on
...
Model Calibration.
Model calibration assesses how well predicted probabilities reflect true out-
...
Few studies have addressed the interplay between label
Comment:
“Few stud-
ies have ad-
dressed..” is
...
Approaches like label correction and robust loss functions have
...
ference papers
to back it up.
(Mots’oehli & kyungim Baek, 2024). We employed the ResNet-18 architecture (He
...
3.3
CALIBRATION METRICS
We evaluated model calibration using Expected Calibration Error (ECE)
Comment:
The cited pa-
per proposes
an improved
...
results were
discussed too.
that the negative impact of label noise on accuracy is consistent across datasets.
...
[CAPTION] Figure 1: CIFAR-10 results: (Left) Test Accuracy vs. Noise Rate; (Right) ECE vs. Noise Rate for

[CAPTION] Figure 2: Test Accuracy (left) and ECE (right) over training epochs for CIFAR-10, MNIST, and

[CAPTION] Figure 2 shows
...
for a possible
explanation.
, reducing ECE marginally but not compensating for the degradation caused
...
[CAPTION] Figure 3: Final Test Accuracy comparison between ResNet-18 and a basic CNN model under sym-

[CAPTION] Figure 3 indicates that while simpler models like a basic CNN perform comparably in terms of
...
A.1
NOISE RATE SENSITIVITY ANALYSIS
...
to account for
duplicates.
CIFAR-10 Test Accuracy vs. Noise Rate for ResNet-18 under symmetric and asymmetric
label noise.
...
[CAPTION] Figure 4 shows that as the noise rate increases, test accuracy decreases steadily for both symmetric
...
checker missed
them.
CIFAR-10 Calibration: (Left) Test Accuracy and ECE over epochs; (Right) Aggregated
...
**[Table p51.1]**
| Comment: Figure 5: The first two ECE acros and last two plots are iden- tical. Also these figures A.2 CA are duplicates |  |  |
| --- | --- | --- |
|  |  | ECE acros A.2 CA |
| of the 1st and We also a 4th plots from mance. Figure 2. The y-axis scaling Figure 5 i is different, The reliab which may come over explain why the duplication checker missed them. A.3 HY |  |  |

[CAPTION] Figure 5:
Comment:

[CAPTION] Figure 2. The

[CAPTION] Figure 5 illustrates that ECE increases as training progresses, especially under higher noise rates.

[CAPTION] Table 1 lists the hyperparameters used in our experiments for reproducibility.

[CAPTION] Table 1: Hyperparameters used in the experiments.

[CAPTION] Figure 6: Comparison of Final Test Accuracy between different models under varying noise levels

[CAPTION] Figure 6 provides additional insights into how different model architectures perform under label
...
Paper Summary
This paper studies the impact of label noise on model calibration using different
...
[CAPTION] Figure 8 | Temperature scaling implementation.

[CAPTION] Figure 9 | Noisy dataset class implementation.
...
[CAPTION] Figure 10 | The implementation for Expected Calibration Error.
...
<!-- page 58 -->
The AI Scientist-v2: Workshop-Level Automated Scientific Discovery via Agentic Tree Search
C.3. Real-world Challenges in Pest Detection using Deep Learning: an Investigation into Failures
and Solutions
...
BY THE AI SCIENTIST-V2
AI Scientist-v2 Generated Preprint
REAL-WORLD CHALLENGES IN PEST DETECTION US-
...
deployed in real-world agricultural settings
Comment:
Both sentences
require cita-
tions to be
substantiated.
. This gap between controlled experiments and real-
...
not in refer-
ences.bib.
on ImageNet , and fine-tuned it on the Crop Pest and Disease dataset
Comment:
Cite. Also
would be nice
to show some
...
not in the bib
file.
the potential of domain adaptation and transfer learning in improving model generalization
Comment:
EuroSAT
might make
sense but using
...
As shown in Figure 1, lower learning rates (1e−4 and 5e−4) result in smoother convergence of
...
environmental
robustness
higher learning rates lead to overfitting
Comment:
The figure
seems to sug-
gest the lower
lr group over-
fits more
and unstable loss patterns, with significant fluctuations in
...
NIST shows erratic accuracy patterns, indicating challenges in
Comment:
Should ex-
plain that this
is more about
...
MedMNIST, or
CIFAR.
generalization due to domain dis-
crepancies.
5.2
CHALLENGES IN MULTI-DATASET TRAINING
...
the MedMNIST model displays fluctuating accuracy, highlighting difficulties in
Comment: a
stretched ar-
gument. Diffi-
culty of adopt-
...
[CAPTION] Figure 1: Baseline model performance across learning rates. Aggregated training and validation ac-

[CAPTION] Figure 2: Comparison of training and validation accuracy across different datasets. Models trained

[CAPTION] Figure 3 illustrates that the models trained on EuroSAT and CIFAR-10 maintain higher ERS scores
...
The legend can
be improved
Environmental Robustness Score (ERS) comparison across different datasets. The Eu-
...
performance.
The exploration of multi-dataset
Comment:
This can be
misleading,
since multi-
...
trained on a
single dataset
training provides valuable insights into domain adaptation chal-
...
SUPPLEMENTARY MATERIAL
A
ADDITIONAL FIGURES AND DETAILED RESULTS
...
β2 = 0.999, and a weight decay of 1e−4. No learning rate schedules or gradient clipping were
Comment:
weight decay
is 0.01 instead
of 1e−4.
...
[CAPTION] Figure 4 shows that the EuroSAT and CIFAR-10 models show consistent decreases in training loss,
...
[CAPTION] Figure 4: Comparison of training loss across different datasets. Models trained on EuroSAT and

[CAPTION] Figure 5: Performance metrics for the model trained on MedMNIST dataset. The erratic behavior
...
Paper Summary
This paper studies the application of Deep Learning models for a real-world
...
[CAPTION] Figure 11 | Domain discriminator and multi-dataset training loop.
...
[CAPTION] Figure 12 | Environment noise simulation implementation.

[CAPTION] Figure 13 | Environmental Robustness Score calculation.
