...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601143340_traceable-autonomous-research-agen_9d75ea/experiments/micro_probe_id004
```
...
```json
{
  ...
  "approved_at": "2026-06-01T14:41:08.029Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
