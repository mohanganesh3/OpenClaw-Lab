...
## Hypothesis
MLE-bench Adaptation for Medical Image Uncertainty Estimation will improve guided idea selection utility over a random baseline under a controlled synthetic research-loop simulation.
...
**Duration**: 10.7s | **Platform**: macOS-26.1-arm64-arm-64bit
