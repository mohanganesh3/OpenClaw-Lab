...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601142057_traceable-autonomous-research-agen_dd7c50/experiments/micro_probe_id004
```
...
```json
{
  ...
  "approved_at": "2026-06-01T14:26:48.944Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
