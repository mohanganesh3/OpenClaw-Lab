...
```text
/export-trajectory run_20260601142057_traceable-autonomous-research-agen_dd7c50
```
...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601142057_traceable-autonomous-research-agen_dd7c50/trajectory_export
```
