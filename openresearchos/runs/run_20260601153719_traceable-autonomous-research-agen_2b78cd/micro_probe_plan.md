...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601153719_traceable-autonomous-research-agen_2b78cd/experiments/micro_probe_id004
```
...
```json
{
  ...
  "approved_at": "2026-06-01T15:42:42.775Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
