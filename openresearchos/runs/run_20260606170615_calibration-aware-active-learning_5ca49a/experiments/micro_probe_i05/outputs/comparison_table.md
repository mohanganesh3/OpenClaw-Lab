...
## Hypothesis
Probabilistic Embeddings for Calibration-Aware Sampling will improve guided idea selection utility over a random baseline under a controlled synthetic research-loop simulation.
...
**Duration**: 10.4s | **Platform**: macOS-26.1-arm64-arm-64bit
