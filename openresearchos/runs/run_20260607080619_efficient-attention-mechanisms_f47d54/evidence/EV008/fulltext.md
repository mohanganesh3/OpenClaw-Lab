...
[CAPTION] Figure 1: VOYAGER discovers new Minecraft items and skills continually by self-driven exploration,
...
[CAPTION] Figure 2: VOYAGER consists of three key components: an automatic curriculum for open-ended
...
**[Table p3.1]**
| Inventory (5/36): {'oak_planks': 3, 'stick': 4, 'crafting_table': 1, 'stone': 3, 'wooden_pickaxe': 1} | GPT-4 |
| --- | --- |
| Biome: river Inventory (4/36): {'sugar_cane': 3, 'paper': 3, 'fishing_rod': 1, 'wooden_pickaxe': 1} |  |
| Nearby entities: pig, cat, villager Health: 12/20 Hunger: 0/20 |  |
| Inventory (6/36): {'furnace': 1, 'stone_pickaxe': 1, 'oak_planks': 7, 'crafting_table': 1, 'raw_iron': 4, 'coal': 1} |  |
| Time: night Nearby entities: zombie Equipment: 'stone_sword', 'shield' |  |
|  | GPT-4 |

[CAPTION] Figure 3: Tasks proposed by the automatic curriculum. We only display the partial prompt for brevity.
...
**[Table p4.1]**
| GPT-3.5 Embedding Key Add Value | Mine Wood Log Make Crafting Table Craft Wooden Pickaxe Craft Stone Sword Make Furnace ... Combat Cow Cook Steak Craft Iron Axe Combat Zombie |
| --- | --- |


**[Table p4.2]**
| aft Iron Pickaxe Top-5 Relevant Skills To craft an iron pickaxe, you Smelt Iron Ingot an iron pickaxe in GPT-3.5 n ste ice kd s t .o O 3 n cir eo n y oin ug ho at vs ea n gd at 2 h ered Embedding Query Skill LibraryRetrieve Craft Stick the materials, .... Make Crafting Table ---------------------------------- Make Furnace Environment Feedback Craft Wooden Pickaxe |  | op-5 Rel | evant Skills |
| --- | --- | --- | --- |
|  | To craft an iron pickaxe, you need to 3 iron ingots and 2 sticks. Once you have gathered the materials, .... ---------------------------------- Environment Feedback |  |  |
| GPT-3.5 |  |  |  |

[CAPTION] Figure 4: Skill library. Top: Adding a new skill. Each time GPT-4 generates and verifies a new
...
**[Table p5.1]**
| I cannot make stick because I need: 2 more planks I cannot make stone_shovel because I need: 2 more stick |  |
| --- | --- |
|  | GPT-4 |


**[Table p5.2]**
| throw new Error(`No item named ${name}`); No item named acacia_axe at line 18:await craftItem(bot, "acacia_axe", 1); |  |
| --- | --- |
|  | GPT-4 |

[CAPTION] Figure 5: Left: Environment feedback. GPT-4 realizes it needs 2 more planks before crafting sticks.
...
**[Table p6.1]**
| Inventory (8/36): {'oak_planks': 5, 'cobblestone': 2, 'porkchop': 2, 'wooden_sword': 1, 'coal': 5, 'wooden_pickaxe': 1, 'oak_log': 3, 'dirt': 9} Task: Mine 5 coal ores |  | Reasoning: Mining coal_ore in Minecraft will get coal. You have 5 coal in your inventory. Success: True |
| --- | --- | --- |
|  | GPT-4 |  |


**[Table p6.2]**
| Inventory (10/36): {'raw_copper': 9, 'copper_ingot': 3, Reasoning: To craft a spyglass, you need 2 copper ingots and 1 amethyst shard. 'acacia_planks': 1, 'raw_iron': 1, 'stick': 1, 'iron_sword': 1, You have 3 copper ingots, but you don't have any amethyst shards. GPT-4 'iron_pickaxe': 1, 'iron_ingot': 3, 'crafting_table': 1, 'furnace': 1} Success: False Task: Craft a spyglass Critique: Find and mine an amethyst shard underground. Inventory (7/36): {'oak_log': 5, 'oak_planks': 1, Reasoning: You have 2 white_wool and 6 mutton in your inventory, which indicates 'wooden_pickaxe': 1, 'wooden_sword': 1, 'porkchop': 2, GPT-4 that you killed 2 sheep. You needed to kill 3 sheep. 'white_wool': 2, 'mutton': 6} Success: False Task: Kill 3 sheep Critique: Find and kill one more sheep to complete the task. Inventory (9/36): {'string': 4, 'coal': 1, 'rotten_flesh': 1, Reasoning: You have 1 rotten_flesh in your inventory, which means you have killed 'iron_sword': 1, 'furnace': 1, 'dirt': 6, 'stone_shovel': 1, GPT-4 at least 1 zombie. 'wooden_pickaxe': 1, 'granite': 5} Success: True Task: Kill 1 zombie |  |
| --- | --- |
| Inventory (9/36): {'string': 4, 'coal': 1, 'rotten_flesh': 1, 'iron_sword': 1, 'furnace': 1, 'dirt': 6, 'stone_shovel': 1, 'wooden_pickaxe': 1, 'granite': 5} Task: Kill 1 zombie |  |
|  | GPT-4 |

[CAPTION] Figure 6: Self-verification examples. We only display the partial prompt for brevity. See Appendix,
...
| --- | --- |
| ReAct [29] Refelxion [30] AutoGPT [28] VOYAGER w/o Skill Library VOYAGER (Ours) | N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) 92 ± 72 (3/3) 94 ± 72 (3/3) 135 ± 103 (3/3) N/A (0/3) 7 ± 2 (3/3) 9 ± 4 (3/3) 29 ± 11 (3/3) N/A (0/3) 6 ± 2 (3/3) 11 ± 2 (3/3) 21 ± 7 (3/3) 102 (1/3) |

[CAPTION] Table 1: Tech tree mastery. Fractions indicate the number of successful trials out of three total runs.

[CAPTION] Figure 7: Map coverage: bird’s eye views of Minecraft maps. VOYAGER is able to traverse 2.3×
...
| --- | --- |
| ReAct [29] Refelxion [30] AutoGPT [28] AutoGPT [28] w/ Our Skill Library VOYAGER w/o Skill Library VOYAGER (Ours) | N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) N/A (0/3) 39 (1/3) 30 (1/3) N/A (0/3) 30 (2/3) 36 (2/3) 30 ± 9 (3/3) 27 ± 9 (3/3) 26 ± 3 (3/3) 19 ± 3 (3/3) 18 ± 7 (3/3) 21 ± 5 (3/3) 18 ± 2 (3/3) |

[CAPTION] Table 2: Zero-shot generalization to unseen tasks. Fractions indicate the number of successful

[CAPTION] Figure 8: Zero-shot generalization to unseen tasks. We visualize the intermediate progress of each
...
[CAPTION] Figure 9: Left: Ablation studies for the automatic curriculum, skill library, and GPT-4. GPT-3.5

[CAPTION] Figure 10: VOYAGER builds 3D structures with human feedback. The progress of building designs
