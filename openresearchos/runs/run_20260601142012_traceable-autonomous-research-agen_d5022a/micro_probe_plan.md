...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601142012_traceable-autonomous-research-agen_d5022a/experiments/micro_probe_id004
```
...
```json
{
  ...
  "approved_at": "2026-06-01T14:20:36.414Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
