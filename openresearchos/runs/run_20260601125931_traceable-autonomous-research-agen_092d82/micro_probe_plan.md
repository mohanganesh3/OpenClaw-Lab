...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601125931_traceable-autonomous-research-agen_092d82/experiments/micro_probe_id010
```
...
```json
{
  ...
  "approved_at": "2026-06-01T12:59:31.752Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
