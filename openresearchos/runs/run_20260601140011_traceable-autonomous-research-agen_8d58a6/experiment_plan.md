...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601140011_traceable-autonomous-research-agen_8d58a6/experiments/micro_probe_id010
```
...
```json
{
  ...
  "approved_at": "2026-06-01T14:00:11.943Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
