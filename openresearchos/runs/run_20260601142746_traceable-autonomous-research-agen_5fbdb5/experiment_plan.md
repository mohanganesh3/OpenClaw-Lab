...
```text
/Users/mohanganesh/OpenClaw-Lab/openresearchos/runs/run_20260601142746_traceable-autonomous-research-agen_5fbdb5/experiments/micro_probe_id004
```
...
```json
{
  ...
  "approved_at": "2026-06-01T14:33:33.866Z",
  "budget": {
    "runtime_minutes": "1-5",
    "max_disk_mb": 250,
